...
from opengraphrag.data_contracts.graph import Entity
from opengraphrag.llm.base import LLMBase
from opengraphrag.prompt.disambiguation import DISAMBIGUATION_ENTITY_PROMPT, DISAMBIGUATION_ENTITY_TYPE_PROMPT, SUMMARY_ENTITY_DISCRIPTIONS_PROMPT
